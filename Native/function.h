...
ONEDAL_C_EXPORT void Train(KNNAlgorithm* engine, void* trainData, void* labelData, int numFeatures, int numRows)
{
  engine->train_with_data(trainData, labelData, numFeatures, numRows);
}
